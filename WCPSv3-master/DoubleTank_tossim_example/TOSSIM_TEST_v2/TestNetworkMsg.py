...
class TestNetworkMsg(tinyos.message.Message.Message):
    # Create a new TestNetworkMsg of size 129.
    ...
    def __str__(self):
        ...
        try:
            s += "  [metric=";
            for i in range(0, 3):
                s += "0x%x " % (self.getElement_metric(i) & 0xffff)
            s += "]\n";
        except:
            pass
        try:
    ...
    #
    # Return whether the field 'metric' is an array (True).
    #
    ...
    #
    def offsetBits_metric(self, index1):
        offset = 48
        if index1 < 0 or index1 >= 3:
            raise IndexError
        offset += 0 + index1 * 16
    ...
    #
    # Return the entire array 'metric' as a int[]
    #
    def get_metric(self):
        tmp = [None]*3
        for index0 in range (0, self.numElements_metric(0)):
                tmp[index0] = self.getElement_metric(index0)
        return tmp
    
    #
    # Set the contents of the array 'metric' from the given int[]
    #
    def set_metric(self, value):
        for index0 in range(0, len(value)):
            self.setElement_metric(index0, value[index0])

    #
    # Return an element (as a int) of the array 'metric'
    #
    def getElement_metric(self, index1):
        return self.getUIntElement(self.offsetBits_metric(index1), 16, 1)
    
    #
    # Set an element of the array 'metric'
    #
    def setElement_metric(self, index1, value):
        self.setUIntElement(self.offsetBits_metric(index1), 16, value, 1)
    
    #
    # Return the total size, in bytes, of the array 'metric'
    #
    def totalSize_metric(self):
        return (48 / 8)
    
    #
    # Return the total size, in bits, of the array 'metric'
    #
    def totalSizeBits_metric(self):
        return 48
    
    #
    # Return the size, in bytes, of each element of the array 'metric'
    #
    def elementSize_metric(self):
        return (16 / 8)
    
    #
    # Return the size, in bits, of each element of the array 'metric'
    #
    def elementSizeBits_metric(self):
        return 16
    
    #
    # Return the number of dimensions in the array 'metric'
    #
    def numDimensions_metric(self):
        return 1
    
    #
    # Return the number of elements in the array 'metric'
    #
    def numElements_metric():
        return 3
    ...
    #
    def numElements_metric(self, dimension):
        array_dims = [ 3,  ]
